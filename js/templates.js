let templates = {
    "se": {
    linkFormat: (x, search, searchString, url, endString, example) => {                                        
                x =`<a 
                    href="${url}${searchString.toLowerCase()}${endString}"
                    target="_blank" 
                    class="textlink" 
                    onclick="addWord('${search}','${example}'); this.style.color = 'rgb(64, 64, 64)'; this.style.backgroundColor = 'rgb(246, 246, 246)';"
                    ondrop="drop(event,'${search.toLowerCase()}', '${example}'); this.style.color = 'rgb(64, 64, 64)'; this.style.backgroundColor = 'rgb(246, 246, 246)';"
    ...
    wordItem: (itemId, word, word2, example, translation, annotation) => {
